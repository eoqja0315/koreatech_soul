...
public class SpendList extends Activity {
    ...
    static final int DIALOG_CATEGORY = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category = (TextView)findViewById(R.id.et_category);
    ...
    protected Dialog onCreateDialog(int id) {
        switch(id) {
            ...
            case DIALOG_CATEGORY:
                final CharSequence[] items = {"식비", "학비", "의류", "기타생활비"};

                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                builder.setTitle("카테고리를 선택해주세요");
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int item) {
                        category.setText(items[item].toString());
                    }
                });
    ...
    public void onClick_OK(View v) {
        ...
        if(!money.equals("") && !breakdown.equals("")) {
